...
<span style="color:rgba(10, 100, 180, 0.7);">DTR: In general the lab looks good.  The instructions below indicate that every team member should participate in making the document: 1) having a few commits each in the early sections, and 2) having each member draft their own "Reflections". However, only Henry has any commits modifying the document. I won't be strict about it in this lab, I know that each of you did some work for the lab. 

<span style="color:rgba(10, 100, 180, 0.7);">The Kanban board that you made is pretty good, with mock cards as sample tasks at different stages of completion.</span>

<span style="color:rgba(10, 100, 180, 0.7);">I like your reflections, they are honest and actionable. Seems that when you worked on this lab, you clearly identified issues that your team could improve. Looking at your team work in class in the past few lectures, it concerns me that these did not get better throughout the term.</span>

<span style="color:rgba(500, 100, 25, 1);">**Grade: 96%**</span>
